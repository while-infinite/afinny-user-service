...
(
    ...
    user_block_expiration TIMESTAMP  NOT NULL
);
...
(
    sms_block_sending_mobile_phone          UUID PRIMARY KEY,
    sms_block_sending_sending_count         INTEGER NOT NULL,
    sms_block_sending_sms_block_expiration  TIME    NOT NULL
);